...
(function() {
  ...
  app.get('/spectra/javascripts/dweet.io.min.js', function(req, res) {
    return res.sendfile(__dirname + '/spectra/javascripts/dweet.io.min.js');
  });
  ...
  app.get('/spectra/javascripts/libs/jquery.min.js', function(req, res) {
    return res.sendfile(__dirname + '/spectra/javascripts/libs/jquery.min.js');
  });

  app.get('/spectra/javascripts/pathAnimator.js', function(req, res) {
    return res.sendfile(__dirname + '/spectra/javascripts/pathAnimator.js');
  });
  ...
  app.get('/spectra/font/fontawesome-webfont.woff', function(req, res) {
    return res.sendfile(__dirname + '/spectra/font/fontawesome-webfont.woff');
  });
  ...
  app.get('/spectra/images/sun.svg', function(req, res) {
    return res.sendfile(__dirname + '/spectra/images/sun.svg');
  });

  app.get('/spectra/images/canvas.svg', function(req, res) {
    return res.sendfile(__dirname + '/spectra/images/canvas.svg');
  });
  ...
  dweetio.listen_for("d2dweath", function(dweet) {
    ...
    return console.log(dweet.content);
  });
