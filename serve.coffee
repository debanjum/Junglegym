...
app.get '/spectra/javascripts/dweet.io.min.js', (req, res) ->
	res.sendfile __dirname + '/spectra/javascripts/dweet.io.min.js'
...
app.get '/spectra/javascripts/libs/jquery.min.js', (req, res) ->
    res.sendfile __dirname + '/spectra/javascripts/libs/jquery.min.js'
    
app.get '/spectra/javascripts/pathAnimator.js', (req, res) ->
    res.sendfile __dirname + '/spectra/javascripts/pathAnimator.js'
...
app.get '/spectra/font/fontawesome-webfont.woff', (req, res) ->
    res.sendfile __dirname + '/spectra/font/fontawesome-webfont.woff'
...
app.get '/spectra/images/sun.svg', (req, res) ->
    res.sendfile __dirname + '/spectra/images/sun.svg'
    
app.get '/spectra/images/canvas.svg', (req, res) ->
    res.sendfile __dirname + '/spectra/images/canvas.svg'    
